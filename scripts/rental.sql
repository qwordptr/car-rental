...
--
-- Host: localhost
-- Czas generowania: 22 Mar 2018, 06:34
...
(5, 'A10', 'Audi', 'Prestige', '2.5', 'Diesel', 23123123, 2012, 'Automatyczna', '2312312313131', 'Klimatronik', 'KN723AS');
...
(6, 3, '2018-03-21 22:43:55', '2018-03-31 00:00:00', 1, 245),
(7, 5, '2018-03-21 22:44:09', '2018-03-30 00:00:00', 0, 2992);
...
(9, 7, 11, '2018-03-21 22:52:04', '2018-03-24 00:00:00', '2018-03-31 00:00:00', 7, 20944, 'approved');
...
--
ALTER TABLE `car`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id pojazdu', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT dla tabeli `notice`
--
ALTER TABLE `notice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'notice id', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT dla tabeli `rentalOrder`
--
ALTER TABLE `rentalOrder`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'notice id', AUTO_INCREMENT=10;
...
--
ALTER TABLE `notice`
  ADD CONSTRAINT `FK_480D45C2C3C6F69F` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`) ON DELETE SET NULL;
